...
const ACCEPTED = '.pdf,.png,.jpg,.jpeg,.webp,.tif,.tiff,application/pdf,image/png,image/jpeg,image/webp,image/tiff'
    ...
    <section className="source-picker" aria-labelledby="source-heading">
      <div className="section-heading-row">
        <div className="section-heading-copy">
          <span className="eyebrow">01 · 文档来源</span>
          <h2 id="source-heading">选择文档</h2>
          <p>上传本地文件，或粘贴可公开访问的文档地址。</p>
        </div>
          ...
          source.file ? (
            ...
            >
              ...
              <div>
                ...
                <p title="支持 PDF、PNG、JPEG、WEBP、TIFF">PDF · PNG · JPEG · WEBP · TIFF</p>
              </div>
